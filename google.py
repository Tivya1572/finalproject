...
def get_google_api_connection():
    ...
    SHEET_ID = '____________________________________________________________'
    SHEET_NAME = '______________________________________________-'
    ...
    for key, item in newval:
        ...
        spreadsheet_key = '_____________________________________________________'
        wks_name = '__________________'
